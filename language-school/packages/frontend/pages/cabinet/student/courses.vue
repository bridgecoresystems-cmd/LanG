  ...
  <div class="student-courses-page">
    <div class="page-header">
      <div class="page-header__text">
        ...
        <p class="page-header__subtitle">Здесь отображаются все ваши активные и завершенные курсы</p>
      </div>
    </div>
...
const loadCourses = async () => {
  ...
  try {
    ...
    coursesData.value = {
      courses: data,
      total: data.length,
      active: data.filter((c: any) => c.is_active).length,
      completed: data.filter((c: any) => !c.is_active).length
    }
  } catch (e) {
