  ...
  <div class="cabinet-page">
    <header class="page-header">
      <div class="page-header__text">
        ...
        <p class="page-header__subtitle">Список занятий группы. Клик — просмотр урока</p>
      </div>
    </header>
    ...
    <div v-else-if="lessons.length > 0" class="lessons-list">
      <NuxtLink
        ...
        :key="lesson.id"
        :to="`/cabinet/student/groups/${groupId}/lessons/${lesson.id}`"
        class="lesson-row"
      >
...
import { NH1, NIcon, NEmpty, NSpin } from 'naive-ui'
