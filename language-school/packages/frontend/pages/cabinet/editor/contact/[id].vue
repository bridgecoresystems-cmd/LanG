<template>
  <div class="cabinet-page-content">
    <div class="row items-center q-mb-lg">
      ...
      <div class="col-auto">
        <q-btn outline color="grey-7" icon="arrow_back" label="Назад" to="/cabinet/editor/contact" />
      </div>
    </div>
    ...
    <q-card v-if="!loading || form.name" flat bordered class="cabinet-form-card">
      <q-card-section>
        <q-form @submit.prevent="handleSubmit" class="cabinet-form">
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-2">
              <q-input v-model.number="form.likes" label="Лайки" type="number" min="0" outlined readonly class="q-mb-md">
          ...
          <div class="row q-gutter-sm q-mt-lg">
            <q-btn type="submit" color="primary" label="Сохранить" :loading="saving" icon="save" size="lg" class="q-px-xl" />
            <q-btn outline color="grey-7" label="Отмена" to="/cabinet/editor/contact" size="lg" />
          </div>
        </q-form>
      </q-card-section>
    </q-card>
