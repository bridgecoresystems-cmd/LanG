<template>
  <div class="cabinet-page-content">
    <div class="row items-center q-mb-lg">
      <div class="col">
        <h1 class="text-h4 q-ma-none">Редактировать категорию (Редактор)</h1>
      </div>
      <div class="col-auto">
    ...
    <q-inner-loading :showing="loading && !form.name_ru">
      <q-spinner size="50px" color="primary" />
    </q-inner-loading>

    <q-card v-if="!loading || form.name_ru" flat bordered class="cabinet-form-card">
      <q-card-section>
