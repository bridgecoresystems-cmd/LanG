<template>
  <div class="cabinet-page-content">
    <div class="row items-center justify-between q-mb-md">
      <h1 class="text-h4 q-ma-none">Подкатегории курсов (Редактор)</h1>
      <q-btn color="primary" icon="add" label="Добавить подкатегорию" to="/cabinet/editor/subcategories/add" />
    </div>
...
const editItem = (id: number) => navigateTo(`/cabinet/editor/subcategories/${id}`)
