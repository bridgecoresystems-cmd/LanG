...
const isHeadAccountant = computed(() => 
  authStore.user?.role === 'HEAD_ACCOUNTANT' || 
  authStore.user?.role === 'GEN_DIRECTOR' || 
...
const columns = [
  ...
  },
  {
    ...
    render: (row: any) => h(NButton, {
      ...
      secondary: true,
      onClick: () => navigateTo({
        path: isHeadAccountant.value ? '/cabinet/head-accountant/payments/add' : '/cabinet/accountant/payments/add',
