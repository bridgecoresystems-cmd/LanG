  ...
  <div class="cabinet-page">
    <header class="page-header">
      <div class="page-header__text">
        <NH2 class="page-header__title">Редактировать звонок</NH2>
      </div>
    ...
    <NCard v-if="!loading || form.firstName" class="cabinet-card" :content-style="{ padding: '32px' }">
      <NSpin :show="loading && !form.firstName">
...
const { getById, update } = useCabinetSales()
  ...
  try {
    ...
    if (item) {
      ...
      const dt = typeof itemData.datetime === 'string' 
        ? new Date(itemData.datetime).getTime() 
        : (itemData.datetime instanceof Date ? itemData.datetime.getTime() : itemData.datetime)
      
      form.value = {
        firstName: itemData.firstName || '',
        lastName: itemData.lastName || '',
        phone: itemData.phone || '',
        datetime: dt as number,
