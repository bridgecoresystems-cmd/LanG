<template>
  <div class="admin-page-content">
    <div class="row items-center justify-between q-mb-md">
      <h1 class="text-h4 q-ma-none">Курсы</h1>
      <q-btn color="primary" icon="add" label="Добавить курс" to="/admin/landing/courses/add" />
    </div>
...
const editItem = (id: number) => navigateTo(`/admin/landing/courses/${id}`)
