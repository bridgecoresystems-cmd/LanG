  ...
  <AdminLayout>
    <div class="admin-page">
      ...
      <div class="row items-center q-mb-lg">
        <div class="col">
          <h1 class="text-h4 q-ma-none">{{ $t('admin.actions.edit') }} {{ $t('admin.courses.categories') }}</h1>
        </div>
        <div class="col-auto">
          <q-btn
            outline
...
const { t } = useI18n()
const { loading, error, fetchCategory, updateCategory } = useAdminCourseCategories()
