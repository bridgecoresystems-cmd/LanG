  ...
  <AdminLayout>
    <div class="admin-page">
      ...
      <div class="row items-center q-mb-md">
        <div class="col">
          <h1 class="text-h4 q-ma-none">{{ $t('admin.courses.categories') }}</h1>
        </div>
        <div class="col-auto">
          <q-btn
            color="primary"
            :label="$t('admin.actions.add') + ' ' + $t('admin.courses.categories')"
            icon="add"
            :to="{ name: 'AdminCourseCategoryAdd' }"
          />
        </div>
      </div>
...
const { loading, error, fetchCategories, deleteCategory } = useAdminCourseCategories()
...
const editItem = (id: number) => {
  router.push(`/management/course-categories/${id}/change`)
}
