  ...
  <AdminLayout>
    <div class="admin-page">
      ...
      <div class="row items-center q-mb-lg">
        <div class="col">
          <h1 class="text-h4 q-ma-none">{{ $t('admin.actions.add') }} {{ $t('admin.courses.subCategories') }}</h1>
        </div>
        <div class="col-auto">
          <q-btn
            outline
      ...
      <!-- Form Card -->
      <q-card v-if="!loadingCategories" flat bordered>
        <q-card-section>
...
const { loading, error, createSubCategory } = useAdminCourseSubCategories()
