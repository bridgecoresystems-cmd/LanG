  ...
  <AdminLayout>
    <div class="admin-page">
      <div class="page-header">
        <h1>{{ $t('admin.actions.add') }} {{ $t('admin.models.administrator') }}</h1>
...
const { t } = useI18n()
const { loading, error, createAdministrator } = useAdminAdministrators()
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await createAdministrator(dataToSend)
